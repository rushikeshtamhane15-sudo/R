...
// generic utensil icon. Lowercased + simple regex match keeps it forgiving
// to admin-typed category names ("Mains", "main course", "Curry & Dal"…).
...
/**
 * Sticky horizontal category navigation. Each chip pairs a floating circular
 * Lucide icon (cat-icon-3d) with a small label below — giving the strip a 3D
 * "ledge" feel. Active state lifts + tints the icon in the primary color.
 */
